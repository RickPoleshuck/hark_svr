...
import comp.pts.hark.svr.domain.ApplicationUser;
import comp.pts.hark.svr.repository.ApplicationUserRepository;
...
class ApplicationUserResourceIT {
    ...
    private static final Instant DEFAULT_LAST_ACCESS = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_LAST_ACCESS = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static ApplicationUser createEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().lastAccess(DEFAULT_LAST_ACCESS).ipAddress(DEFAULT_IP_ADDRESS);
    ...
    public static ApplicationUser createUpdatedEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().lastAccess(UPDATED_LAST_ACCESS).ipAddress(UPDATED_IP_ADDRESS);
        return applicationUser;
    }
    ...
    void createApplicationUser() throws Exception {
        ...
        assertThat(testApplicationUser.getLastAccess()).isEqualTo(DEFAULT_LAST_ACCESS);
        assertThat(testApplicationUser.getIpAddress()).isEqualTo(DEFAULT_IP_ADDRESS);
    }
    ...
    void putNewApplicationUser() throws Exception {
        ...
        updatedApplicationUser.lastAccess(UPDATED_LAST_ACCESS).ipAddress(UPDATED_IP_ADDRESS);
        ...
        ApplicationUser testApplicationUser = applicationUserList.get(applicationUserList.size() - 1);
        assertThat(testApplicationUser.getLastAccess()).isEqualTo(UPDATED_LAST_ACCESS);
        assertThat(testApplicationUser.getIpAddress()).isEqualTo(UPDATED_IP_ADDRESS);
    }
    ...
    void partialUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.ipAddress(UPDATED_IP_ADDRESS);
    ...
    void fullUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.lastAccess(UPDATED_LAST_ACCESS).ipAddress(UPDATED_IP_ADDRESS);
