...
/**
 * REST controller for managing {@link comp.pts.hark.svr.domain.ApplicationUser}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<ApplicationUser> result = applicationUserRepository
            ...
            .map(
                existingApplicationUser -> {
                    if (applicationUser.getLastAccess() != null) {
                        existingApplicationUser.setLastAccess(applicationUser.getLastAccess());
                    }
                    if (applicationUser.getIpAddress() != null) {
                        existingApplicationUser.setIpAddress(applicationUser.getIpAddress());
                    }
