package comp.pts.hark.svr.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, comp.pts.hark.svr.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, comp.pts.hark.svr.repository.UserRepository.USERS_BY_EMAIL_CACHE);
